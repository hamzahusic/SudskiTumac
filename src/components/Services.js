...
const Services = () => {
    ...
    return ( 
        <div className="containter pt-20 lg:pt-32 pb-8 px-5 md:px-0">
            <h2 className='primaryFont text-center text-[25px] font-medium pb-5 tracking-wide px-0 md:px-5'>{langdb.serviceTitle}</h2>
            <p className='text-center text-lg pb-10 px-0 md:px-5'>{langdb.serviceDesc}</p>
